...
| SAPIENT `DetectionReport` → `Track` (WGS84, UTM, range/bearing, deprecated feet variants) | `transform/detection.rs` |
...
ensures sensors remain tasked during Peat network partitions, and
